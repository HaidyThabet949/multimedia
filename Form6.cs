    ...
    public partial class Form6 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                dataGridView1.Columns[1].HeaderText = "Form";
            ...
            try
            {
                ...
                dataGridView2.Columns[1].HeaderText = "Form";
                dataGridView2.Columns[2].HeaderText = "To";
                dataGridView2.Columns[3].HeaderText = "Range";
        ...
        void arith_method(int char_index, Double big_from, Double big_to)
        {
            ...
            result.Add(temp);
            arith_method(char_index + 1, char_Start, char_End);
        }
